...
const RecipeUpdate = () => {
  ...
  return (
    <div className='flex justify-center items-center h-[100vh] w-full'>
      ...
      <input className='border-b outline-0 pb-2' {...register("image")} type="url" />
      <input className='border-b outline-0 pb-2' {...register("title")} type="text" />
      <textarea className='border-b p-2 outline-0 cursor-pointer mt-2'{...register("description")} type="text" ></textarea>
      <select className='border-b  p-2 outline-0 cursor-pointer mt-2'{...register("category")} type="text" >
