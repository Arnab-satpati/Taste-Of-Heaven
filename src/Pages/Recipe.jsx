...
const Recipe = () => {
  ...
  return (
    <div className='flex justify-center items-center w-[100%] relative custom-scrollbar'>
      <button onClick={() => navigate('/create')} className="px-[3rem] py-[.7rem] text-[#c9c3c3] fixed outline-1 z-55 cursor-pointer bg-[#6d6b6b11] outline-[#666464] backdrop-blur-md top-6.5 right-50 hover:bg-[#ffffff11] rounded-2xl ">
        Add recipe
      </button>
